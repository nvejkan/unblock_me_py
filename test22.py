...
b1.place_block(i_star,(2,1))

i1 = Block('A',3,'down')
b1.place_block(i1,(0,0))

i2 = Block('B',2,'down')
b1.place_block(i2,(0,2))

i3 = Block('C',3,'right')
b1.place_block(i3,(0,3))

i4 = Block('D',3,'down')
b1.place_block(i4,(1,3))

i5 = Block('E',3,'down')
b1.place_block(i5,(2,4))

i6 = Block('F',2,'down')
b1.place_block(i6,(1,5))

i7 = Block('G',2,'down')
b1.place_block(i7,(3,5))

i9 = Block('H',2,'down')
b1.place_block(i9,(3,1))

i10 = Block('I',2,'right')
b1.place_block(i10,(4,2))

i11 = Block('J',3,'right')
b1.place_block(i11,(5,0))
print(b1.board)
